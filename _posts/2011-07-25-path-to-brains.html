...
blogger_orig_url: https://chrisglein.blogspot.com/2011/07/path-to-brains.html
---

In late 2006 (yes, this story starts *five years ago*) Microsoft released the first version of XNA, a development platform for writing games on the PC and Xbox. It put all the nitty-gritty details that generally plague game development behind a modern type-safe programming language (C#). It let developers focus on the more interesting aspects of game design. As someone who has [dabbled in game development](http://si.hlgaming.com/) in the past, this simplified platform sounded like a great way for me to get back into it.
<!--more-->

I wanted a project that fit me and my personal strengths, so I decided on a 2D game where I could provide the art with old fashioned pen and paper. This would accomplish two things: it would give me an excuse to [reconnect](http://chrisglein.blogspot.com/2011/07/back-to-creation.html) with the visual arts, and it would produce a different visual style from most of the other stuff out there. I imagined a sketchy hand-drawn style, like doodles in a notebook come to life. Of course I wasn't the only one to have this idea, and in fact many games have come out in the years since with this style. Many have fallen short because they fail to embrace the look completely, while others have pulled it off brilliantly (like the enjoyable [Parachute Panic](http://marketplace.xbox.com/en-US/WindowsPhone/Parachute-Panic/38484d96-56fe-df11-9264-00237de2db9e)). But from my perspective at the time, it wasn't a look that had been done.
...
Where am I going with this? Well, when it comes to video games, violence is a common crutch because our brain easily understands "death == losing". And when it comes to violence, zombies are a generally agreeable adversary. So when I decided to make a game, I decided to make a zombie game. It's also possible that its just because I had recently rolled off of playing [Dead Rising](http://www.giantbomb.com/dead-rising/61-8720/). In going back to unravel the timeline I remembered that I'd actually already posted about the topic of [zombie gaming](http://chrisglein.blogspot.com/2007/11/zombie-gaming.html) here in 2007. That post was actually a product of me thinking about what sort of game I wanted to make. And that exercise led me down the path of [discovering](http://chrisglein.blogspot.com/2008/01/zombie-board-game.html) modern designer board games. Which it turns out has turned into quite a hobby for me.
...
![5.png](https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEhA828xqC7Y-WC6g2MY6sbwp7o3d5b0FQwkbeT3QHklts_PxQjm_uEAfPEDZiOGfToNBqM95gP3CMwrAvLnXWNrb20iLjvve_x5xAQrtj2yAxaFSak01Oaeg0uB-bgp-LoYewZuQEQjDLo/s1600/5.png)

MustEatBrains is now available for download for Windows Phone [here](http://windowsphone.com/s?appid=feabce8d-c6af-e011-a53c-78e7d1fa76f8).