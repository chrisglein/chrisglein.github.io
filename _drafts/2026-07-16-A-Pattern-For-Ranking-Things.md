...
- It had to be good for focused listening (eager to sit in the same room with, willing to get up and flip the disc).
- And ideally the record itself is an aesthetically pleasing object, a little piece of personal expression on the shelf.
...
So I built a small thing to help: it shows you two items, you pick the one you like more, and after a handful of rounds it hands you have a ranked list, or at least a group of tiers. Once I had this, it kept finding ways to use it.

I vibe-coded an initial solution: a single page of HTML that shows you two items, you pick the one you like more, and after a handful of rounds it hands you your ranked list (or at least a group of tiers). It worked great. We used it to narrow the field and pick a dozen records to start the collection with.

### Board Games

I have a group of friends that meets regularly to play board games. Over time I've developed a feel for what lands and what doesn't. And I've already spent time here outlining [how I rate games]({% post_url 2024-08-16-The-Cody-Scale %}). But I was curious about the unspoken preferences hidden under the surface and overwhelmed by group think.
...
Over lunch a coworker asked everyone for their top four movies. I declined to answer on the spot, but the question stuck with me. Over the following weeks I kept bringing it up with other friends, sparking all sorts of great conversations. But making a concrete list is hard.
...
Clearly, this stopped being a one-off and has became a pattern I turn to. It's a tool for overcoming the challenge of big absolute judgments and turning that into smaller relative ones.
...
I've put the whole thing up as open source [here](https://github.com/chrisglein/bracket-game). 
